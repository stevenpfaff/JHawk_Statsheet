...
class TourneyPlayers extends Component {
    constructor(props) {
        super(props);
        this.state = { player: [] }
    ...
    refreshList() {
        fetch(process.env.REACT_APP_API + 'tourneyplayer')
    ...
    render() {
        return (
            <div style={{ marginRight: "25%", marginLeft: "25%", marginBottom: "10%" }} >
                ...
                <h1 style={{ marginRight: "10%", marginLeft: "10%", marginBottom: "5%", marginTop: "5%", fontFamily: "inherit" }}>Tourney Batting Stats</h1>
                <Link to={'/Players'}><Button type="submit" variant="contained" class="btn btn-primary">Total Stats</Button></Link>
                <Link to={'/LeaguePlayers'}><Button type="submit" variant="contained" class="btn btn-primary">League Stats</Button></Link>
                ...
                <h1 style={{ marginRight: "10%", marginLeft: "10%", marginBottom: "5%", marginTop: "5%", fontFamily: "inherit" }}>Tourney Pitching Stats</h1>
                <Table striped bordered hover>
                    <thead>
                        <tr>
                            <th>Player</th>
